...
export const headerTextAtom = atom("Home");
    ...
    <div className="sticky top-0 bg-white z-50 ml-[16%] w-[85%] border-b border-[#D9D9D9]">
      <div className="flex items-center justify-between py-5 px-10">
        ...
        <div className="text-[#1A181E] flex items-center justify-center gap-x-5">
          <h3 className="text-[15px] font-normal">{headerText}</h3>
          {/* How it works */}
          <div className="flex items-center justify-center gap-x-[6px]">
            <span className="cursor-pointer">
              <svg
                ...
                fill="none"
              >
                <g clip-path="url(#clip0_12602_2522)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
        ...
        {/* Search */}
        <div className="w-[400px] h-[40px] px-[16px] py-[9px] border bg-[#F2F2F2] rounded-[6px] flex items-center justify-centers gap-2">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <div className="flex items-center justify-center gap-x-5">
          <div className="w-[40px] h-[40px] bg-[#E6E6E6] rounded-full flex items-center justify-center cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <div className="w-[40px] h-[40px] bg-[#E6E6E6] rounded-full flex items-center justify-center cursor-pointer">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_12602_2537)">
